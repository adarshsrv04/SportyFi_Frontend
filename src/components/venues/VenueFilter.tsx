...
const VenueFilter = ({ onFilterChange }: VenueFilterProps) => {
  ...
  const handlePriceChange = (value: number[]) => {
    ...
    setFilters({ ...filters, priceRange: inverted });
    onFilterChange({ ...filters, priceRange: inverted });
  };
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-3">
            <div className="flex items-center">
              <Label className="mr-2 whitespace-nowrap">Prices:</Label>
              <div className="flex-1 px-2">
                ...
                <Slider
                  value={[
                    5000 - filters.priceRange[1],
                    5000 - filters.priceRange[0],
                  ]}
                  min={0}
                  max={5000}
                  step={100}
...
//   const handleSportChange = (value: string) => {
//     const newFilters = { ...filters, sport: value };
//     setFilters(newFilters);
//     onFilterChange(newFilters);
//   };
...
//   // Reverse slider logic
//   const handlePriceChange = (value: number[]) => {
//     const inverted: [number, number] = [
//       5000 - (value[1] ?? 5000),
//       5000 - (value[0] ?? 0),
//     ];
//     const newFilters = { ...filters, priceRange: inverted };
//     setFilters(newFilters);
//     onFilterChange(newFilters);
//   };
