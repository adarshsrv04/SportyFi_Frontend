...
//                                     <input
//                                       type="time"
//                                       step="60" // 60 = 1 minute precision, change to 300 for 5-minute intervals
//                                       value={field.value || ""}
...
//                             {/* ✅ Separate Terms & Conditions Container */}
...
//                                       <button
//                                         type="button"
//                                         className="text-sportyfi-orange underline"
//                                       >
//                                         Terms & Conditions
//                                       </button>
//                                     </DialogTrigger>
...
//                                         <p>
//                                           4. Venue may cancel in case of unforeseen circumstances.
//                                         </p>
...
const VenueDetail = () => {
  ...
  const onSubmit = (values: BookingFormValues) => {
    ...
    // navigate("/venuepayment", { state: { formData, totalPrice, venue } });
  };
